...
public class CreateTemplateFragment extends Fragment implements ScreenShotable, View.OnClickListener, View.OnLongClickListener {
    ...
    public static CreateTemplateFragment newInstance(int resId) {
        CreateTemplateFragment addRecordFragment = new CreateTemplateFragment();
    ...
    public void takeScreenShot() {
        Thread thread = new Thread() {
            ...
            public void run() {
                ...
                CreateTemplateFragment.this.bitmap = bitmap;
            }
        };
        thread.start();
    }
