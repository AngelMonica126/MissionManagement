 ...
 */
public class MyHoverTouchHelper {
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    switch (motionEvent.getAction()) {
                        case MotionEvent.ACTION_DOWN:
                            ...
                            Blurry.with(root.getContext()).radius(8).sampling(2).capture(root).into(MyHoverTouchHelper.addBlurView(root));
                        ...
                        case MotionEvent.ACTION_UP:
                            MyHoverTouchHelper.removeBlurView(root, duration);
    ...
    public static ImageView addBlurView(ViewGroup root){
    ...
    public static void removeBlurView(final ViewGroup root, int duration) {
