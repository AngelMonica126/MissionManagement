...
public class MySquareMenu extends View {

    private static final String TAG = MySquareMenu.class.getSimpleName();
    ...
    private static final String DEFAULT_DIRECTION = TOP_RIGHT;
    ...
    public MySquareMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void setupAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs,R.styleable.MySquareMenu, 0, 0);
        // Extract custom attributes into member variables
        Drawable iconM1, iconM2, iconM3;
        try {
            fabColor = a.getColor(R.styleable.MySquareMenu_mfabColor, 0);
            fabWidth = fabHeight = a.getInteger(R.styleable.MySquareMenu_mfabSize, FAB_SIZE);
            menuOpenDirection = a.getString(R.styleable.MySquareMenu_mmenuOpenDirection);
            if (menuOpenDirection == null) menuOpenDirection = DEFAULT_DIRECTION;
            iconM1 = a.getDrawable(R.styleable.MySquareMenu_miconM1);
            iconM2 = a.getDrawable(R.styleable.MySquareMenu_miconM2);
            iconM3 = a.getDrawable(R.styleable.MySquareMenu_miconM3);
        } finally {
    ...
    private void setupPaint() {
        ...
        paintFabBGWidShadow.setStyle(Paint.Style.STROKE);
